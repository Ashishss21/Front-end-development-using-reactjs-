...
import {Jumbotron, Navbar, NavbarBrand, Nav, NavbarToggler, Collapse,
     NavItem, Modal, ModalHeader, ModalBody, Button, Form, FormGroup, Label, Input} from 'reactstrap';
...
class Header extends Component
{
    ...
    handleLogin(){
        this.toggleModal();
        alert("Usename:"+this.username.value+" "+"Password:"+this.password.value+"Remember Me:"+this.remember.checked);
